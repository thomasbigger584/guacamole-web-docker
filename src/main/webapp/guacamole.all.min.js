...
Guacamole.StringReader=function(b){var a=this;b=new Guacamole.ArrayBufferReader(b);var d=0,c=0;b.ondata=function(b){var e="";b=new Uint8Array(b);for(var k=0;k<b.length;k++){var m=b[k];0===d?127===(m|127)?e+=String.fromCharCode(m):223===(m|31)?(c=m&31,d=1):239===(m|15)?(c=m&15,d=2):247===(m|7)?(c=m&7,d=3):e+="ï¿½":191===(m|63)?(c=c<<6|m&63,d--,0===d&&(e+=String.fromCharCode(c))):(d=0,e+="ï¿½")}if(a.ontext)a.ontext(e)};b.onend=function(){if(a.onend)a.onend()};this.onend=this.ontext=null};
Guacamole=Guacamole||{};
